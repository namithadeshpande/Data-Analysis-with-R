...
- [NYC School Perceptions](https://github.com/namithadeshpande/Data-Analysis-with-R/blob/master/NYC_School_Survey_Data.Rmd) - Responses to surveys designed to gauge parent, student, and teacher perceptions of the quality of New York City schools.  In this project, a few questions with respect to the same are answered.
